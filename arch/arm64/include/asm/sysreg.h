...
#define SCTLR_ELx_EnALS	(BIT(56))
#define SCTLR_ELx_EnAS0	(BIT(55))
#define SCTLR_ELx_EnASR	(BIT(54))
...
#define INIT_SCTLR_EL2_MMU_ON						\
	(SCTLR_ELx_M  | SCTLR_ELx_C | SCTLR_ELx_SA | SCTLR_ELx_I |	\
	 ...
	 SCTLR_ELx_ITFSB | SCTLR_ELx_EnASR | SCTLR_ELx_EnAS0 |          \
	 SCTLR_ELx_EnALS | SCTLR_EL2_RES1)
...
#define INIT_SCTLR_EL1_MMU_ON \
	(SCTLR_ELx_M      | SCTLR_ELx_C      | SCTLR_ELx_SA    | \
	 ...
	 SCTLR_EL1_TSCXT  | SCTLR_EL1_EOS    | SCTLR_ELx_EnASR | \
	 SCTLR_ELx_EnAS0  | SCTLR_ELx_EnALS )
